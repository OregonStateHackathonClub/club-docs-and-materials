...
## Coding Platform
There are several competitive coding platforms available that may be suitable to host weekly competitions. In August, 2020 I emailed several companies and only Code Chef was able to host our challenges but we decided to stay with HackerRank due to their poor user interface. 
...
## Description
We chose to create a theme for this quarter but feel free to get creative or just choose coding challenges at random.
